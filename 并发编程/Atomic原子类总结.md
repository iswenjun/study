...
![JUC原子类概览](Atomic原子类总结.assets/JUC原子类概览.png)
...
> **🐛 修正（参见：[issue#626  (opens new window)](https://github.com/Snailclimb/JavaGuide/issues/626)）** : `AtomicMarkableReference` 不能解决 ABA 问题。
...
public class AtomicIntegerTest {
	...
	public static void main(String[] args) {
		// 这些方法都是返回前一个值（the previous value）
		int temvalue = 0;
